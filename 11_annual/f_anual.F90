...
integer, parameter::nsp=7 !number of pollutants
...
data casn /'MEX_POINT_9km_2008_PM10.nc','MEX_POINT_9km_2008_PM25.nc',&
'MEX_POINT_9km_2008_SO2.nc ','MEX_POINT_9km_2008_CO.nc  ',&
'MEX_POINT_9km_2008_NOx.nc ','MEX_POINT_9km_2008_VOC.nc ',&
'MEX_POINT_9km_2008_NH3.nc '/
...
!    print *,"Globales"
    ...
    call check( nf90_put_att(ncid, NF90_GLOBAL, "id","PE_2008_"//trim(ename(k))))
