...
character (len=19) :: current_date='2008-01-01_00:00:00'
 !> Input file name
...
&           'ACO__2008.csv','APM10_2008.csv',&
&           'APM25_2008.csv',&
&           'AVOC_2008.csv'/
 data casn /'MEX_AREA_9km_2008_SO2.nc ','MEX_AREA_9km_2008_NOx.nc ',&
&           'MEX_AREA_9km_2008_NH3.nc ','MEX_AREA_9km_2008_CO.nc  ',&
&           'MEX_AREA_9km_2008_PM10.nc',&
&           'MEX_AREA_9km_2008_PM25.nc','MEX_AREA_9km_2008_VOC.nc '/
...
call check( nf90_put_att(ncid, NF90_GLOBAL, "id","AE_2008_"//trim(ename(k))))
