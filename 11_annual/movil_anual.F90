...
character (len=19) :: current_date='2008-01-01_00:00:00';!> output file name
...
character (len=40) :: titulo
 ...
 data efile / 'M_CO.csv' ,'M_NH3.csv','M_NOx.csv',&
              'M_SO2.csv','M_PM10.csv','M_PM25.csv','M_VOC.csv'/

data casn /'MEX_MOBILE_9km_2008_CO.nc  ','MEX_MOBILE_9km_2008_NH3.nc ',&
           'MEX_MOBILE_9km_2008_NOx.nc ',&
           'MEX_MOBILE_9km_2008_SO2.nc ',&
           'MEX_MOBILE_9km_2008_PM10.nc','MEX_MOBILE_9km_2008_PM25.nc',&
           'MEX_MOBILE_9km_2008_VOC.nc '/
...
data ename/'CO  ','NH3 ','NOx ','SO2 ','PM10','PM25','VOC '/
data cname / &
...
call check( nf90_put_att(ncid, NF90_GLOBAL, "id","ME_2008_"//trim(ename(k))))
call check( nf90_put_att(ncid, NF90_GLOBAL, "title","Emissions from criteria pollutants and GHG for 2008"))
...
call check( nf90_put_att(ncid, NF90_GLOBAL, "time_coverage_start","2008-01-01T06:00:00Z"))
call check( nf90_put_att(ncid, NF90_GLOBAL, "time_coverage_end","2009-01-01T05:00:00Z"))
...
call check( nf90_put_att(ncid, NF90_GLOBAL, "summary","National emissions inventory for Mexico 2008 &
...
call check( nf90_put_att(ncid, id_unlimit, "units", "years since 2008-01-01T06:00:00Z"))
...
!  Coordenadas Mercator UTM
    ...
    !Tiempo
    call check( nf90_put_var(ncid, id_dim(1),"2008-01-01_06:00:00"))! one year output
